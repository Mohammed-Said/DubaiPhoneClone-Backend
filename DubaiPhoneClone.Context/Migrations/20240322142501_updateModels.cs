    ...
    public partial class updateModels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WishlistItemsId = table.Column<int>(type: "int", nullable: false),
                    WishlistItemsId1 = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductUser", x => new { x.WishlistItemsId, x.WishlistItemsId1 });
                    table.ForeignKey(
